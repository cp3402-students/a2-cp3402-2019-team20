...
if ( ! function_exists( 'coffeecan_setup' ) ) :
	/**
	 ...
	 */
	function coffeecan_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on CoffeeCan, use a find and replace
		 * to change 'coffeecan' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'coffeecan', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'coffeecan_custom_background_args', array(
 ...
 */
function coffeecan_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'coffeecan_content_width', 640 );
}
add_action( 'after_setup_theme', 'coffeecan_content_width', 0 );
 ...
 */
function coffeecan_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'coffeecan' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'coffeecan' ),
...
add_action( 'widgets_init', 'coffeecan_widgets_init' );
...
//    wp_localize_script('coffeecan-navigation', 'coffeecanScreenReaderText', array(
//        'expand' => __('Expand child menu', 'coffeecan'),
//        'collapse' => __('Collapse child menu', 'coffeecan')
//    ));
...
add_action( 'wp_enqueue_scripts', 'coffeecan_scripts' );
