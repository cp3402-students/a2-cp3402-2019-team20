...
if ( ! function_exists( 'coffeecan_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function coffeecan_posted_on() {
...
if ( ! function_exists( 'coffeecan_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'coffeecan_entry_footer' ) ) :
	 ...
	 */
	function coffeecan_entry_footer() {
...
if ( ! function_exists( 'coffeecan_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function coffeecan_post_thumbnail() {
